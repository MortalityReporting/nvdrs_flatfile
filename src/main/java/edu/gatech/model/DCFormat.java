...
public class DCFormat extends BaseSerializedFormat {
    ...
    protected SerialField<DeathManner> mannerOfDeathOnDC = new SerialField<DeathManner>("Manner of death on DC", 658, 658);
    ...
    protected SerialField<FIPSCodes> stateOrTerritoryWhereInjuryOccurred = new SerialField<FIPSCodes>("State or territory where injury occurred", 781, 782);
