...
import edu.gatech.model.enumvalueset.FIPSCode;
...
public class DCFormat extends BaseSerializedFormat {
    ...
    protected SerialField<FIPSCode> stateOrTerritoryOfDeath = new SerialField<FIPSCode>("State or territory of death", 36, 37);
    ...
    protected SerialField<CharLimitedInteger> maritalStatus = new SerialField<CharLimitedInteger>("Marital status", 62, 62);
    protected SerialField<CharLimitedInteger> placeOfDeath = new SerialField<CharLimitedInteger>("Place of Death", 63, 63);
    ...
    protected SerialField<CharLimitedInteger> educationByDegree = new SerialField<CharLimitedInteger>("Education by degree", 68, 68);
    protected SerialField<String> hispanicLatinoSpanish1 = new SerialField<String>("Hispanic/Latino/Spanish", 69, 69);
    protected SerialField<String> hispanicLatinoSpanish2 = new SerialField<String>("Hispanic/Latino/Spanish", 70, 70);
    protected SerialField<String> hispanicLatinoSpanish3 = new SerialField<String>("Hispanic/Latino/Spanish", 71, 71);
    protected SerialField<String> hispanicLatinoSpanish4 = new SerialField<String>("Hispanic/Latino/Spanish", 72, 72);
    protected SerialField<String> white = new SerialField<String>("White", 73, 73);
    protected SerialField<String> blackOrAfricanAmerican = new SerialField<String>("Black or African American", 74, 74);
    protected SerialField<String> americanIndianOrAlaskaNative = new SerialField<String>("American Indian or Alaska Native", 75, 75);
    protected SerialField<String> asian = new SerialField<String>("Asian", 76, 76);
    protected SerialField<String> asianIndian = new SerialField<String>("Asian Indian", 77, 77);
    protected SerialField<String> chinese = new SerialField<String>("Chinese", 78, 78);
    protected SerialField<String> filipino = new SerialField<String>("Filipino", 79, 79);
    protected SerialField<String> japanese = new SerialField<String>("Japanese", 80, 80);
    protected SerialField<String> korean = new SerialField<String>("Korean", 81, 81);
    protected SerialField<String> vietnamese = new SerialField<String>("Vietnamese", 82, 82);
    protected SerialField<String> nativeHawaiianOrOtherPacificIslander = new SerialField<String>("Native Hawaiian or other Pacific Islander", 83, 83);
    protected SerialField<String> nativeHawaiian = new SerialField<String>("Native Hawaiian", 84, 84);
    protected SerialField<String> guamanianOrChamorro = new SerialField<String>("Guamanian or Chamorro", 85, 85);
    protected SerialField<String> samoan = new SerialField<String>("Samoan", 86, 86);
    protected SerialField<String> otherRace = new SerialField<String>("Other race", 87, 87);
    protected SerialField<String> unspecifiedRace = new SerialField<String>("Unspecified race", 88, 88);
    ...
    protected SerialField<CharLimitedInteger> victimWasPregnant = new SerialField<CharLimitedInteger>("Victim was pregnant", 657, 657);
    protected SerialField<String> mannerOfDeathOnDC = new SerialField<String>("Manner of death on DC", 658, 658);
    ...
    protected SerialField<String> injuredAtWork = new SerialField<String>("Injured at work", 672, 672);
    protected SerialField<String> autopsyPerformed = new SerialField<String>("Autopsy performed", 673, 673);
    ...
    protected SerialField<CharLimitedInteger> icd10TypeOfActivityWhenInjured = new SerialField<CharLimitedInteger>("ICD-10 Type of Activity when Injured (\"5th Character\")", 682, 682);
    protected SerialField<String> typeOfLocationWhereInjured = new SerialField<String>("Type of location where injured", 683, 684);
    protected SerialField<CharLimitedInteger> icd10TypeOfPlaceWhereInjured = new SerialField<CharLimitedInteger>("ICD-10 Type of Place where Injured (\"4th Character\")", 685, 685);
